...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-path", "LuaSnip", "friendly-snippets", "cmp_luasnip" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "C:\\Users\\HUYNH MINH KHANG\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\nvim-cmp",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'galaxyline.nvim', 'nvim-cursorline', 'bufferline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
